...
function getGnomeKeyringRemediationMessage(): string {
  return "DevGame could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart DevGame.";
}

function getKWalletRemediationMessage(): string {
  return "DevGame could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart DevGame.";
}
