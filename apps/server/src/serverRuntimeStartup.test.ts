    ...
    Effect.gen(function* () {
      ...
      yield* ServerRuntimeStartup.launchStartupHeartbeat.pipe(
        Effect.provideService(ProjectionSnapshotQuery.ProjectionSnapshotQuery, {
          ...
          getActiveSpacesForProject: () => Effect.succeed([]),
          getSpaceProjectId: () => Effect.succeed(Option.none()),
  ...
  return Effect.gen(function* () {
    ...
    const targets = yield* ServerRuntimeStartup.resolveAutoBootstrapWelcomeTargets.pipe(
      ...
      Effect.provideService(ProjectionSnapshotQuery.ProjectionSnapshotQuery, {
        ...
        getActiveSpacesForProject: () => Effect.die("unused"),
        getSpaceProjectId: () => Effect.die("unused"),
