          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  DEVGAME_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(
                    /^Bearer\s+/,
                    "",
                  ),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.devgame.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.devgame.bearer_token_env_var="DEVGAME_MCP_BEARER_TOKEN"',
                ],
              }
            : {}),
        };
