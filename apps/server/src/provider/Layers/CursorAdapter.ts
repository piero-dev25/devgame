      ...
      withThreadLock(
        ...
        Effect.gen(function* () {
          ...
          const acp = yield* makeCursorAcpRuntime({
            ...
            clientInfo: { name: "devgame", version: "0.0.0" },
            ...(mcpSession
              ? {
                  mcpServers: [
                    {
              ...
              Effect.gen(function* () {
                switch (event._tag) {
                  ...
                  case "ContentDelta":
                    ...
                    return;
                  // Task #67: sibling of "ContentDelta" above — an image
                  // ACP's ContentBlock union carries inline in the
                  // assistant's own content stream.
                  case "ImageDelta":
                    yield* logNative(
                      ctx.threadId,
                      "session/update",
