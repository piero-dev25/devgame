            ...
            return yield* finish(
              makeUpdateState({
                ...
                message: couldNotVerify
                  ? "Update command completed, but DevGame could not verify the provider version."
                  : stillOutdated
                    ? "Update command completed, but DevGame still detects an outdated provider version."
                    : "Provider updated.",
                output: commandOutput(result),
              }),
            );
